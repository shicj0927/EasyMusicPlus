...
class DownloadDialog(QDialog):
    ...
    startDownloadSignal = pyqtSignal(object,str,str,str)
    ...
    def on_download_with_info_clicked(self, row):
        ...
        self.start_download(songInfo, None, None)
    ...
    def on_download_with_url_clicked(self):
        ...
        if url=="":
            ...
            return
        self.ui.qTabWidget_mainTabs.setCurrentIndex(1)
        self.start_download(None, url, None)
    ...
    def on_download_with_mediaId_clicked(self):
        ...
        if mediaId=="":
            ...
            return
        self.ui.qTabWidget_mainTabs.setCurrentIndex(1)
        self.start_download(None, None, mediaId)
    ...
    def start_download(self, songInfo, url, mediaId):
        ...
        self.ui.qTextBrowser_taskDetail.append(f"下载参数：{songInfo}, {url}, {mediaId}")
        downloadPath = self.ui.qLineEdit_outputPath.text()
        if downloadPath=="":
            downloadPath="./downloads"
        self.startDownloadSignal.emit(songInfo, url, mediaId, downloadPath)
